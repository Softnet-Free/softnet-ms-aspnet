...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="susite.aspx.cs" Inherits="susite" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" EnableViewState="false" %>
        ...
        <div class="site_body">        
            ...
            <div class="site_block">
                ...
                <div class="site_block_item">
                    ...
                    <asp:Panel ID="P_ServiceEdit" Visible="false" EnableViewState="false" style="padding-top: 15px;" runat="server">
                    </asp:Panel>
                    </div>
            </div>
