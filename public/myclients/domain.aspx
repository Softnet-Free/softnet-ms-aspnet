<%@ Page Language="C#" AutoEventWireup="true" CodeFile="domain.aspx.cs" Inherits="public_myclients_domain" MasterPageFile="~/Site.master" EnableViewState="false" MaintainScrollPositionOnPostback="true"  %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table class="wide_table"><tr>
        ...
        <td class="wide_table" style="padding-top: 0px; vertical-align:top;">
            <h3 style="text-align: center">domain <asp:HyperLink CssClass="h3_name provider_color" ID="HL_Domain" runat="server"/></h3>            
        </td>
