...
public partial class suclients : System.Web.UI.Page
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        try
        {
            ...
            if (m_siteDataset.siteData.siteKind != 1 || m_siteDataset.services.Count != 1 || m_siteDataset.siteData.constructed == false || m_siteDataset.siteData.rolesSupported)
            {
    ...
    {
        Response.Redirect(m_urlBuider.getNextUrl(string.Format("~/domains/deletesite.aspx?sid={0}", m_siteData.siteId), string.Format("~/domains/suclients.aspx?sid={0}", m_siteData.siteId)));
    }
    ...
    protected void AddClient_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/suclients.aspx?sid={0}&cid={1}&cpr=1", m_siteData.siteId, clientId)));
        }
        catch (SoftnetException ex)
        {
            ExceptionHandler.exec(this, ex);
    ...
    protected void EditClient_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/suclients.aspx?sid={0}&cid={1}&cpr=1", m_siteData.siteId, clientData.clientId)));
    }
    ...
    protected void EditClientPing_Click(object sender, EventArgs e)
    {
        TButton button = (TButton)sender;
        ClientData clientData = (ClientData)button.Args[0];
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/suclients.aspx?sid={0}&cid={1}&cpr=2", m_siteData.siteId, clientData.clientId)));
    }
    ...
    protected void SetPingPeriod_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/suclients.aspx?sid={0}&cid={1}", m_siteData.siteId, clientData.clientId)));
        }
