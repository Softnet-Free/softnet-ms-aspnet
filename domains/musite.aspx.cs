...
public partial class musite : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(m_urlBuider.getNextUrl(string.Format("~/domains/newuser.aspx?did={0}", m_siteDataset.domainId), string.Format("~/domains/musite.aspx?sid={0}", m_siteData.siteId)));
    }
    ...
    {
        Response.Redirect(m_urlBuider.getNextUrl(string.Format("~/domains/deletesite.aspx?sid={0}", m_siteData.siteId), string.Format("~/domains/musite.aspx?sid={0}", m_siteData.siteId)));
    }

    protected void EditSiteDescription_Click(object sender, EventArgs e)
    {
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&sp=1", m_siteData.siteId)));
    }
    ...
    {
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&sp=2", m_siteData.siteId)));
    }
    ...
    {
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&sp=3", m_siteData.siteId)));
    }
    ...
    protected void EditService_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&srid={1}&srp=1", m_siteData.siteId, serviceData.serviceId)));
    }
    ...
    protected void EditHostname_Click(object sender, EventArgs e)
    {
        TButton button = (TButton)sender;
        ServiceData serviceData = (ServiceData)button.Args[0];
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&srid={1}&srp=2", m_siteData.siteId, serviceData.serviceId)));
    }
    ...
    protected void EditServiceEnabledStatus_Click(object sender, EventArgs e)
    {
        TButton button = (TButton)sender;
        ServiceData serviceData = (ServiceData)button.Args[0];
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&srid={1}&srp=3", m_siteData.siteId, serviceData.serviceId)));
    }
    ...
    protected void ShowApplyStructure_Click(object sender, EventArgs e)
    {
        TButton button = (TButton)sender;
        ServiceData serviceData = (ServiceData)button.Args[0];
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&srid={1}&srp=4", m_siteData.siteId, serviceData.serviceId)));
    }
    ...
    protected void ShowPingSettings_Click(object sender, EventArgs e)
    {
        TButton button = (TButton)sender;
        ServiceData serviceData = (ServiceData)button.Args[0];
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/musite.aspx?sid={0}&srid={1}&srp=5", m_siteData.siteId, serviceData.serviceId)));
    }   
    ...
    void LoadData()
    {
        ...
        foreach (UserData userData in explicitUsers)
        {
            ...
            if (userData.kind == 2)
            {
                ...
                buttonEditUser.Text = "rem";
                buttonEditUser.ID = "B_RemoveUser_" + userData.userId.ToString();
                buttonEditUser.Click += new EventHandler(RemoveUser_Click);
        ...
        foreach (UserData userData in implicitUsers)
        {
            ...
            if (userData.kind == 2)
            {
                ...
                buttonEditUser.Args.Add(userData);
                buttonEditUser.Text = "+";
                buttonEditUser.ID = "B_AddUser_" + userData.userId.ToString();
                buttonEditUser.Click += new EventHandler(AddUser_Click);
