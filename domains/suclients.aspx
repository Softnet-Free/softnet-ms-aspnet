<%@ Page Language="C#" AutoEventWireup="true" CodeFile="suclients.aspx.cs" Inherits="suclients" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" EnableViewState="false" %>
    ...
    <div class="site_frame" style="margin-bottom: 20px;">
        ...
        <div class="site_body">       
            <div class="site_block">
                <div class="site_block_header left">service</div>
            ...
            <div class="site_block">
                ...
                <div class="site_block_item">
                    <span class="name">Implicit users&nbsp;&nbsp;</span><asp:Label ID="L_ImplicitUserStatus" runat="server"/>
                </div>
            </div>
