...
public partial class muclients : System.Web.UI.Page
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        try
        {
            ...
            SoftnetRegistry.GetUSiteClientsDataset(this.Context.User.Identity.Name, siteId, m_siteDataset);
    ...
    {
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/muclients.aspx?sid={0}", m_siteData.siteId)));
    }
    ...
    {
        Response.Redirect(m_urlBuider.getNextUrl(string.Format("~/domains/deletesite.aspx?sid={0}", m_siteData.siteId), string.Format("~/domains/muclients.aspx?sid={0}", m_siteData.siteId)));
    }
    ...
    protected void AddClient_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/muclients.aspx?sid={0}&cid={1}&cpr=1", m_siteData.siteId, clientId)));
        }
        catch (SoftnetException ex)
        {
            ExceptionHandler.exec(this, ex);
    ...
    protected void EditClient_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/muclients.aspx?sid={0}&cid={1}&cpr=1", m_siteData.siteId, clientData.clientId)));
    }
    ...
    protected void EditClientPing_Click(object sender, EventArgs e)
    {
        TButton button = (TButton)sender;
        ClientData clientData = (ClientData)button.Args[0];
        Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/muclients.aspx?sid={0}&cid={1}&cpr=2", m_siteData.siteId, clientData.clientId)));
    }
    ...
    protected void SetPingPeriod_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Redirect(m_urlBuider.getLoopUrl(string.Format("~/domains/muclients.aspx?sid={0}&cid={1}", m_siteData.siteId, clientData.clientId)));
        }
    ...
    void LoadData()
    {
        ...
        {
            HtmlGenericControl divBlockItem = new HtmlGenericControl("div");
            divBlockItem.Attributes["class"] = "site_block_item underline";

            HtmlGenericControl table = new HtmlGenericControl("table");
            divBlockItem.Controls.Add(table);
            table.Attributes["class"] = "wide_table";
            HtmlGenericControl tr = new HtmlGenericControl("tr");
            table.Controls.Add(tr);

            HtmlGenericControl tdDescription = new HtmlGenericControl("td");
            tr.Controls.Add(tdDescription);
            tdDescription.Attributes["class"] = "wide_table";
            tdDescription.Attributes["style"] = "text-align:left";
            ...
            tdDescription.Controls.Add(table);
            ...
            tdHostname.Attributes["style"] = "padding-right: 15px;";
            ...
            PH_Services.Controls.Add(divBlockItem);
        }

        if (m_siteData.implicitUsersAllowed)
        {
            L_ImplicitUserStatus.Attributes["class"] = "enabled_status";
            L_ImplicitUserStatus.Text = "allowed";
        }
        else
        {
            L_ImplicitUserStatus.Attributes["class"] = "disabled_status";
        ...
        foreach (UserData userData in allowedUsers)
        {
            ...
            panelUser.EnableViewState = false;
            ...
            if (userData.kind == 2)
            {
                ...
                buttonAddClient.ID = string.Format("B_AddClient_{0}", userData.userId);
                buttonAddClient.Click += new EventHandler(AddClient_Click);

                List<ClientData> userClients = clients.FindAll(x => x.userId == userData.userId);
            ...
            else if (userData.kind == 1)
            {
                ...
                buttonAddClient.Args.Add(userData);
                buttonAddClient.Text = "add client";
                buttonAddClient.ID = string.Format("B_CreateClient_{0}", userData.userId);
                buttonAddClient.Click += new EventHandler(AddClient_Click);
