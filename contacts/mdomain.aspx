...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mdomain.aspx.cs" Inherits="contacts_mdomain" MasterPageFile="~/Site.master" EnableViewState="false" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div style="padding-left: 10px; padding-bottom: 10px">
        <h3>
            <span>contact</span>
            <asp:HyperLink CssClass="h3_name" ID="HL_Contact" runat="server"/>            
        </h3>
    </div>
    ...
    <table class="wide_table" style="width:798px"><tr>
        ...
        <td class="wide_table" style="width: 400px; padding-top: 0px; vertical-align:top;">
            <h2 style="text-align: center">my shared domain <asp:Label CssClass='h2_name domain_color' ID="L_Domain" runat="server"/></h2> 
        </td>
        <td class="wide_table" style="width:199px; vertical-align:top;">
            <table  class="wide_table"><tr>
                <td class="wide_table" style="width:100%"></td>
